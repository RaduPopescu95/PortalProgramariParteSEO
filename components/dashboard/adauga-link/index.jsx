...
const Index = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isEdit) {
        await handleUpdateFirestore(`Links/${documentId}`, formValues);
      } else {
        await handleUploadFirestore(formValues, "Links");
      }
  ...
  const handleQuery = async () => {
    ...
    try {
      const c = await handleQueryFirestore("Links", "id", numericId);
              ...
              <div className="row">
                <div className="col-lg-12 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <BreadCrumb title="Dashboard" subTitle="Adauga Links" />
                  </div>
                </div>
