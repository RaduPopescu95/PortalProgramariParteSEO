...
const Index = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isEdit) {
        await handleUpdateFirestore(`Categorii/${documentId}`, formValues);
      } else {
        await handleUploadFirestore(formValues, "Categorii");
      }
  ...
  const handleQuery = async () => {
    ...
    try {
      const c = await handleQueryFirestore("Categorii", "id", numericId);
              ...
              <div className="row">
                <div className="col-lg-12 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <BreadCrumb title="Dashboard" subTitle="Adauga Categorie" />
                  </div>
                </div>
