...
const CallToAction = ({className}) => {
  return (
    <section className={`start-partners cta-container-section-list ${className}`}>
  ...
  <div className="start_partner tac-smd">
    ...
    <h3>Contactează-ne și îți putem oferi o soluție personalizată pentru afacerea ta!</h3>
